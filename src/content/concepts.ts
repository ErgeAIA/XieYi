...
export const concepts: Concept[] = [
  {
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "已按 15 类收录，支持搜索与一键复制" },
  ...
  },
  {
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「计划 / 引导」类提示词，配合 Plan / Spec 模式先用" }
    ]
  },
  {
    "id": "skill",
  ...
  },
  {
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「理解 / 计划」类提示词，先让 AI 读懂仓库结构" }
    ]
  },
  {
    "id": "git",
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「Git」类提示词：让 AI 安全做分支 / 回退 / 合并" }
    ]
  },
  {
    "id": "commit",
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「Git」类提示词：让 AI 按功能拆提交、写清 why" }
    ]
  },
  {
    "id": "environment",
  ...
  },
  {
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「测试」类提示词：先写测试、再修到通过" }
    ]
  },
  {
    "id": "bug-debug",
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「调试」类提示词：让 AI 按假设-验证法定位问题" }
    ]
  },
  {
    "id": "refactor",
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「重构」类提示词：让 AI 行为不变地拆分 / 改名" }
    ]
  },
  {
    "id": "deploy",
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「发布」类提示词：让 AI 准备上线清单与回滚方案" }
    ]
  },
  {
    "id": "html-css-js",
  ...
  },
  {
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「原型 / 实现」类提示词，一次生成前后端" }
    ]
  },
  {
    "id": "api",
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「实现」类提示词：按契约直接生成接口" }
    ]
  },
  {
    "id": "database",
    ...
    "recommendations": [
      ...
      { "name": "本站提示词指南", "url": "/prompts", "note": "复制「数据」类提示词：让 AI 设计表结构与查询" }
    ]
  }
];
